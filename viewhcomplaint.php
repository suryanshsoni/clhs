...
if(isset($_POST['goback'])){
    ...
    die;
                    ...
                    if(isset($_POST['processhcomplaintbtn'])){
                        @$ids= $_POST['ids'];
...
<h1 class="container text-center" style="margin-top:30px;">Hostel Complaints</h1>
                 ...
                 <div class="container text-center"style="padding-right:0px;">
                    ...
                    <div class="form-group">
                        ...
                        <div  class="text-left container">
                             <?php
                                        $query="select *from complaints where type='hostel'  order by id desc;";
                            ...
                            <br>
                                        <div class="col-lg-offset-4">
                                         <button  type="submit" name="processhcomplaintbtn" class=" btn btn-primary">
                                             Mark as Processed
                                        </button>
                                        </div>
