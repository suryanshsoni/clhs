...
if(isset($_POST['search_donebtn'])){
    ...
    switch($opt){
        ...
        case 'addaccount':{
          //  echo 'student update go'." ".$_POST['selected_student'];
         header ("Location: ./admin_home.php?option=createaccount&student=".$_POST['selected_student']);
        }break;
        case 'viewstudent':{
            header ("Location: ./admin_home.php?option=displaystudent&student=".$_POST['selected_student']);
...
<h1 class="container text-center" style="margin-top:30px;">Select student</h1>
		    ...
		    <div class="form-group"> 
                    ...
                    <input type="text" class="form-control" name="searchterm" placeholder="Name/Room number ">
                    </div>
